...
public enum MrcpMethodName {
  ...
  */
  ...
  /*
   * synthesizer-method = "SPEAK" ; A / "STOP" ; B / "PAUSE" ; C / "RESUME" ; D / "BARGE-IN-OCCURRED" ; E / "CONTROL" ; F / "DEFINE-LEXICON" ; G
   */
  /**
  ...
  /*
   * recog-only-method = "DEFINE-GRAMMAR" ; A / "RECOGNIZE" ; B / "INTERPRET" ; C / "GET-RESULT" ; D / "START-INPUT-TIMERS" ; E / "STOP" ; F
   */
  /**
  ...
  /*
   * enrollment-method = "START-PHRASE-ENROLLMENT" ; G / "ENROLLMENT-ROLLBACK" ; H / "END-PHRASE-ENROLLMENT" ; I / "MODIFY-PHRASE" ; J / "DELETE-PHRASE" ; K
   */
  ...
  /*
   * recorder-Method = "RECORD" ; A / "STOP" ; B / "START-INPUT-TIMERS" ; C
   */
  ...
  /*
   * verification-method = "START-SESSION" ; A / "END-SESSION" ; B / "QUERY-VOICEPRINT" ; C / "DELETE-VOICEPRINT" ; D / "VERIFY" ; E / "VERIFY-FROM-BUFFER" ; F / "VERIFY-ROLLBACK" ; G / "STOP" ; H / "CLEAR-BUFFER" ; I / "START-INPUT-TIMERS" ; J / "GET-INTERMEDIATE-RESULT" ; K
   */
  /**
