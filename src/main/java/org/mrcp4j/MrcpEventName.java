...
public enum MrcpEventName {
  ...
  */
  ...
  /*
   * recognizer-event = "START-OF-INPUT" ; L / "RECOGNITION-COMPLETE" ; M / "INTERPRETATION-COMPLETE" ; N
   */
  /**
  ...
  /*
   * recorder-event = "START-OF-INPUT" ; D / "RECORD-COMPLETE" ; E
   */
  ...
  /*
   * verification-event = "VERIFICATION-COMPLETE" ; L / "START-OF-INPUT" ; M
   */
  /**
