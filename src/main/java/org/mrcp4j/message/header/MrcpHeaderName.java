...
///////////////////////////////////////
  ...
  ACCEPT_CHARSET("Accept-Charset"), CONTENT_ID("Content-Id"), CONTENT_TYPE("Content-Type"),
  ...
  CACHE_CONTROL("Cache-Control" /* , MapFactory.class or CacheDirectiveList */), LOGGING_TAG("Logging-Tag"),
  SET_COOKIE("Set-Cookie" /* , CookieList.class */), SET_COOKIE2("Set-Cookie2" /* , Cookie2List.class */),
...
///////////////////////////////////////
  ...
  COMPLETION_REASON("Completion-Reason"), VOICE_PARAMETER("Voice-Parameter"), PROSODY_PARAMETER("Prosody-Parameter"),
  SPEECH_MARKER("Speech-Marker"), SPEECH_LANGUAGE("Speech-Language"), FETCH_HINT("Fetch-Hint"),
  AUDIO_FETCH_HINT("Audio-Fetch-Hint"), FETCH_TIMEOUT("Fetch-Timeout"), FAILED_URI("Failed-URI"),
  FAILED_URI_CAUSE("Failed-URI-Cause"), SPEAK_RESTART("Speak-Restart"), SPEAK_LENGTH("Speak-Length"),
  LOAD_LEXICON("Load-Lexicon"), LEXICON_SEARCH_ORDER("Lexicon-Search-Order"),
...
///////////////////////////////////////
  ...
  INPUT_TYPE("Input-Type"), RECOGNITION_TIMEOUT("Recognition-Timeout"), WAVEFORM_URI("Waveform-URI"),
  ...
  DTMF_INTERDIGIT_TIMEOUT("DTMF-Interdigit-Timeout"), DTMF_TERM_TIMEOUT("DTMF-Term-Timeout"),
  ...
  MEDIA_TYPE("Media-Type"), NEW_AUDIO_CHANNEL("New-Audio-Channel"),
  // SPEECH_LANGUAGE ("Speech-Language"),
  VER_BUFFER_UTTERANCE("Ver-Buffer-Utterance"), RECOGNITION_MODE("Recognition-Mode"),
  CANCEL_IF_QUEUE("Cancel-If-Queue"), HOTWORD_MAX_DURATION("Hotword-Max-Duration"),
  HOTWORD_MIN_DURATION("Hotword-Min-Duration"), INTERPRET_TEXT("Interpret-Text"),
  ONE_OF_RULE_ID_URI("One-Of-Rule-Id-URI"),

  X_NUANCE_MRCP_AUDIO("X-Nuance-Mrcp-Audio"), X_NUANCE_END_OF_SPEECHDATA("X-Nuance-End-Of-SpeechData"),
...
///////////////////////////////////////
  ...
  PERSONAL_GRAMMAR_URI("Personal-Grammar-URI"), ENROLL_UTTERANCE("Enroll-Utterance"), PHRASE_ID("Phrase-Id"),
  PHRASE_NL("Phrase-NL"), WEIGHT("Weight"), SAVE_BEST_WAVEFORM("Save-Best-Waveform"), NEW_PHRASE_ID("New-Phrase-Id"),
  CONFUSABLE_PHRASES_URI("Confusable-Phrases-URI"), ABORT_PHRASE_ENROLLMENT("Abort-Phrase-Enrollment"),
...
///////////////////////////////////////
  ...
  MAX_TIME("Max-Time"), TRIM_LENGTH("Trim-Length"), FINAL_SILENCE("Final-Silence"),
...
///////////////////////////////////////
  ...
  REPOSITORY_URI("Repository-URI"), VOICEPRINT_IDENTIFIER("Voiceprint-Identifier"),
  VERIFICATION_MODE("Verification-Mode"), ADAPT_MODEL("Adapt-Model"), ABORT_MODEL("Abort-Model"),
  ...
  public static EnumSet<MrcpHeaderName> RECOG_ONLY_HEADER_NAMES = EnumSet.of(CONFIDENCE_THRESHOLD, SENSITIVITY_LEVEL,
      SPEED_VS_ACCURACY, N_BEST_LIST_LENGTH, NO_INPUT_TIMEOUT, INPUT_TYPE, RECOGNITION_TIMEOUT, WAVEFORM_URI,
      INPUT_WAVEFORM_URI, COMPLETION_CAUSE, COMPLETION_REASON, RECOGNIZER_CONTEXT_BLOCK, START_INPUT_TIMERS,
      SPEECH_COMPLETE_TIMEOUT, SPEECH_INCOMPLETE_TIMEOUT, DTMF_INTERDIGIT_TIMEOUT, DTMF_TERM_TIMEOUT, DTMF_TERM_CHAR,
      FETCH_TIMEOUT, FAILED_URI, FAILED_URI_CAUSE, SAVE_WAVEFORM, MEDIA_TYPE, NEW_AUDIO_CHANNEL, SPEECH_LANGUAGE,
      VER_BUFFER_UTTERANCE, RECOGNITION_MODE, CANCEL_IF_QUEUE, HOTWORD_MAX_DURATION, HOTWORD_MIN_DURATION,
      INTERPRET_TEXT, ONE_OF_RULE_ID_URI, X_NUANCE_MRCP_AUDIO, X_NUANCE_END_OF_SPEECHDATA);

  public static EnumSet<MrcpHeaderName> ENROLLMENT_HEADER_NAMES = EnumSet.range(NUM_MIN_CONSISTENT_PRONUNCIATIONS,
      ABORT_PHRASE_ENROLLMENT);

  public static EnumSet<MrcpHeaderName> RECORDER_HEADER_NAMES = EnumSet.of(SENSITIVITY_LEVEL, NO_INPUT_TIMEOUT,
      COMPLETION_CAUSE, COMPLETION_REASON, FAILED_URI, FAILED_URI_CAUSE, RECORD_URI, MEDIA_TYPE, MAX_TIME, TRIM_LENGTH,
      FINAL_SILENCE, CAPTURE_ON_SPEECH, VER_BUFFER_UTTERANCE, START_INPUT_TIMERS, NEW_AUDIO_CHANNEL);

  public static EnumSet<MrcpHeaderName> VERIFICATION_HEADER_NAMES = EnumSet.of(REPOSITORY_URI, VOICEPRINT_IDENTIFIER,
      VERIFICATION_MODE, ADAPT_MODEL, ABORT_MODEL, CONFIDENCE_THRESHOLD, NUM_MIN_VERIFICATION_PHRASES,
      NUM_MAX_VERIFICATION_PHRASES, NO_INPUT_TIMEOUT, SAVE_WAVEFORM, MEDIA_TYPE, WAVEFORM_URI, VOICEPRINT_EXISTS,
      VER_BUFFER_UTTERANCE, INPUT_WAVEFORM_URI, COMPLETION_CAUSE, COMPLETION_REASON, SPEECH_COMPLETE_TIMEOUT,
      NEW_AUDIO_CHANNEL, ABORT_VERIFICATION, START_INPUT_TIMERS);
